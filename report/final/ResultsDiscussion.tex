...
With the simplex already in use we ran another experiment with the results displayed on \autoref{fig:res_simplex}. This experiment was run with the box closed and with desk 1 and 3 set as occupied.
