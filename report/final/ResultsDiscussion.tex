...
With the simplex already in use we ran another experiment with the results displayed on Figure~\ref{fig:res_simplex}. This experiement was run with the box closed and with desk 1 and 3 set as occupied.
