...
With the values for $a$ and $b$ and \eqref{eq:log-log_line} it is possible to plot the graph in \autoref{fig:LDR_model} which models the LDR characteristic, as desired.

\begin{figure}[h]
    \centering
    \includegraphics[width=.4\textwidth]{img/LDR_datasheet}
    \caption{LDR resistence as a function of illuminance \\ according to the GL5528's datasheet}
...
\begin{figure}[h]
    ...
    \caption{Resistance of the LDR as function of the incident illuminance}
    \label{fig:LDR_model}
\end{figure}
