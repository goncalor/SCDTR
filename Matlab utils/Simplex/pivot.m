...
% Pivot method used by the simplex algorithm based
% on the pseudo code present in "Introduction to 
% Alorithms" 3rd Edition by Cormen, page 869.


% on the new matrices i_e becomes i_l and vice versa


% Compute the coefficients of the equation for the new
% basic variable x(e)
